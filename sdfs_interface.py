...
def append(s,input):
    sock = socket.socket(socket.AF_INET,socket.SOCK_STREAM)
    sock.connect(("fa18-cs425-g26-01.cs.illinois.edu",6666))

    message = {"op": "append", "s": "sdfs/" + s}
    message = json.dumps(message)
...
if __name__ == "__main__":
    ...
    #C.ls("frequency")
    #append("frequency","ss")
    #append("frequency", "sss")
    #C.get("get",-1,"frequency","fre")
    #append("shit","appleapple")
    #C.get("get",-1,"shit","fre")
