    ...
    with open("ips.txt",'r') as file:
        for line in file:
            ...
            try:
                ...
                ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("git clone git@gitlab.engr.illinois.edu:jyuan18/mp4.git")
    ...
    with open("ips.txt",'r') as file:
        for line in file:
            ...
            try:
                ...
                ssh.set_missing_host_key_policy(paramiko.AutoAddPolicy())
                ssh.connect(ip, username="yixinz6", password="Zyyy9-9-")
                ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("cd ~/mp4/;git stash;git pull")
                print(ssh_stdout.read().decode())
            except:
                print(ip)
                print("error!")
    ...
    with open("ips.txt", 'r') as file:
        for line in file:
            ...
            try:
                ...
                ssh.set_missing_host_key_policy(paramiko.AutoAddPolicy())
                ssh.connect(ip, username="yixinz6", password="Zyyy9-9-")
                ssh.exec_command("cd ~/mp4/;python Supervisor.py &")
    ...
    with open("ips.txt",'r') as file:
        for line in file:
            ...
            try:
                ...
                ssh.set_missing_host_key_policy(paramiko.AutoAddPolicy())
                ssh.connect(ip, username="yixinz6", password="Zyyy9-9-")
                ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("cd ~/mp4/;rm vm.log")
                print(ssh_stdout.read().decode())
            except:
                print(ip)
                print("error!")
    ...
    with open("ips.txt", 'r') as file:
        for line in file:
            ...
            try:
                ...
                ssh.set_missing_host_key_policy(paramiko.AutoAddPolicy())
                ssh.connect(ip, username="yixinz6", password="Zyyy9-9-")
                ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("cd ~/mp4/;rm -rf local0;git pull")
                print(ssh_stdout.read().decode())
                ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("netstat -tulpn")
                lines = (ssh_stdout.readlines())
            except:
